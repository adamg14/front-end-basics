...
export function validateUser(user: UserModel): boolean {
    ...
    if (!Array.isArray(user.permissions) || user.permissions.some(permission => typeof permission !== 'string')) return false;
